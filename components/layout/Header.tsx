  ...
  return (
    <header className="h-16 bg-surface border-b-2 border-dark/15 flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-header">
      ...
      <div className="lg:hidden flex items-center gap-2">
        ...
        <span className="hidden min-[360px]:inline text-[11px] font-bold bg-warning text-dark px-1.5 py-0.5 uppercase">Internal</span>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-4 ml-auto">
        ...
        {/* Streak */}
        {streak > 0 && (
          <div className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 bg-warning/10 border border-warning/30">
        ...
        {/* User */}
        <div className="hidden lg:flex items-center gap-2 text-sm font-semibold text-dark">
